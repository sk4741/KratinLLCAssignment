...
public class SignupRequestDTO {
	...
	public SignupRequestDTO(String userName, String userEmail,String userPassword, String userNumber, String userEmgNumber, int userAge,
	...
	public String toString() {
		return "SignupRequest [userName=" + userName + ", userEmail=" + userEmail + ", userPassword=" + userPassword
				+ ", userNumber=" + userNumber + ", userEmgNumber=" + userEmgNumber + ", userAge=" + userAge
				+ ", userGender=" + userGender + ", userBloodGroup=" + userBloodGroup + ", userHeight=" + userHeight
				+ ", userDiabetes=" + userDiabetes + ", userBloodPressure=" + userBloodPressure + "]";
	}
